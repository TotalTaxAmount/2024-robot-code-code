...
public class RobotContainer {
  ...
  private boolean isRed = DriverStation.getAlliance().isPresent() && DriverStation.getAlliance().get().equals(DriverStation.Alliance.Red);
  ...
  public void configureButtonBindings(){
    ...
    new JoystickButton(secondaryController, XboxController.Button.kA.value).whileTrue(
            new PathCommand(swerveSubsystem, (isRed ? new Translation2d(1,1) : new Translation2d(2, 2)))
    );
